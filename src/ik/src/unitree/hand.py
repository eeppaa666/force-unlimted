...
class HandRetarget:
    ...
    def retarget(self, left_landmarks: np.ndarray, right_landmarks: np.ndarray):
        ...
        # left_input = left_landmarks[self.hand_retargeting.left_indices[1,:]] - left_landmarks[self.hand_retargeting.left_indices[0,:]]
        # right_input = right_landmarks[self.hand_retargeting.right_indices[1,:]] - right_landmarks[self.hand_retargeting.right_indices[0,:]]
